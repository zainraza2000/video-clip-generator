...
For each video, return a structured list of clips. Only include clips that genuinely stand out. Do not include filler or low-impact segments. The total duration of all the selected clips should not exceed ${maxVideoLengthSeconds} seconds (${
